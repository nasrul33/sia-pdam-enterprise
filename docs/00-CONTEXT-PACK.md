...
| BR-PAY-011 | Bank reconciliation handoff export is read-only and includes blank reviewer handoff columns without creating notes or approval mutations | Payment/Reporting | confirmed |
